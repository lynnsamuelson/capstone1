  ...
  .module("balanceItApp.preload", []) 
    .factory ("preload", ['gameFactory', 'getCompounds', function(gameFactory, getCompounds) {
      ...
      return function () {
        ...
        game.load.image("Cl", "images/Cl.jpg  ", 150, 61);
        game.load.image("Ca", "images/Ca.jpg  ", 150, 61);
        game.load.image("Cu", "images/Cu.jpg  ", 150, 61);
        game.load.image("Fl", "images/Fl.jpg  ", 150, 61);
        game.load.image("I", "images/I.jpg  ", 150, 61);
        game.load.image("K", "images/K.jpg  ", 150, 61);
        ...
        game.load.image("MnO2-", "images/MnO2-.jpg  ", 149, 60);
        game.load.image("MnO42-", "images/MnO42-.png  ", 149, 60);
        ...
        game.load.spritesheet("stirbar", "images/stir-bar.jpg", 112, 59);
